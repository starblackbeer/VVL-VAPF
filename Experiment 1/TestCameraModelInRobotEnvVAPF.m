...
workpiece1_hp = PlotCubic(workpiece1,[0.6, 0.1, 0.1],1);
...
for select_index = 1 : index - 1
    ...
    %% Judge the occlusion relationship
    flag(select_index) = 0;
...
%% The camera takes pictures to determine the actual occlusion relationship between the robotic arm and the working space
% % work space
