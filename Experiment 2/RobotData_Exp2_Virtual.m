...
toolobb_para = [40, tool_d(1)/2, tool_d(1)/2; 20, 20, tool_d(2)/2];
tool_theta = [0,0,0,0,0,0];
%% camera
global ConeGeneratrix;
ConeGeneratrix = 30;
global R;
global depth;
R = 30;
depth = 50;
%% process variable
global update_enable;
update_enable = [1 1 1 1];
%% work space
global workplane1;
workplane1.vertex = [400 -600 200];
...
global workpiece1;
workpiece1.vertex = [500 -500 300];
workpiece1.vlength = [1 0 0];
workpiece1.length = 200;
workpiece1.vwidth = [0 1 0];
workpiece1.width = 200;
